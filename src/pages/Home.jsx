...
const Home = () => {
    ...
    return (
        <>
                ...
                <div className="container-custom section-padding">
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        ...
                        <div className="order-2 lg:order-1 animate-fade-in">
                            ...
                            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl text-charcoal leading-tight mb-6">
                                Art That Tells <span className="text-terracotta">Your Story</span>
                            </h1>
                        ...
                        <div className="order-1 lg:order-2 animate-slide-up">
                            <div className="relative">
                                <div className="absolute -inset-4 bg-gradient-to-br from-terracotta/20 to-gold/20 rounded-3xl -z-10"></div>
                                <img
                                ...
                                <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg p-4">
                                    ...
                                    <p className="font-heading text-lg text-charcoal">Love & Clay</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="bg-sand py-8 border-y border-silver">
                <div className="container-custom px-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                        <div>
                            <div className="text-terracotta text-3xl mb-2">🎨</div>
                            <p className="font-heading text-xl text-charcoal">100%</p>
                            <p className="text-sm text-stone">Handcrafted</p>
                        </div>
                        <div>
                            <div className="text-terracotta text-3xl mb-2">⭐</div>
                            <p className="font-heading text-xl text-charcoal">{BUSINESS.rating}/5</p>
                            <p className="text-sm text-stone">Google Rating</p>
                        </div>
                        <div>
                            <div className="text-terracotta text-3xl mb-2">📍</div>
                            <p className="font-heading text-xl text-charcoal">Ahmedabad</p>
                            <p className="text-sm text-stone">Made Locally</p>
                        </div>
                        <div>
                            <div className="text-terracotta text-3xl mb-2">💜</div>
                            <p className="font-heading text-xl text-charcoal">Inclusive</p>
                            <p className="text-sm text-stone">LGBTQ+ Friendly</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="section-padding bg-sand-light">
                <div className="container-custom">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-12">
                        <Link to="/products?category=wall-art" className="group relative overflow-hidden rounded-xl aspect-[4/3]">
                            <img
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-charcoal/80 to-transparent flex items-end p-6">
                                <div>
                                    <h3 className="font-heading text-2xl text-white mb-1">Wall Art</h3>
                                    <p className="text-sand/80 text-sm">Transform your walls with tradition</p>
                                </div>
                            </div>
                        </Link>

                        <Link to="/products?category=home-decor" className="group relative overflow-hidden rounded-xl aspect-[4/3]">
                            <img
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-charcoal/80 to-transparent flex items-end p-6">
                                <div>
                                    <h3 className="font-heading text-2xl text-white mb-1">Home Decor</h3>
                                    <p className="text-sand/80 text-sm">Nameplates, mirrors & clocks</p>
                                </div>
                            </div>
                        </Link>

                        <Link to="/products?category=gifts" className="group relative overflow-hidden rounded-xl aspect-[4/3]">
                            <img
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-charcoal/80 to-transparent flex items-end p-6">
                                <div>
                                    <h3 className="font-heading text-2xl text-white mb-1">Gifting</h3>
                                    <p className="text-sand/80 text-sm">Weddings, festivals & celebrations</p>
                                </div>
                            </div>
                        </Link>
                    </div>
                ...
                <div className="container-custom">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="relative">
                            ...
                            />
                            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-terracotta rounded-full flex items-center justify-center">
                                <div className="text-center text-sand-light">
                        ...
                        <div>
                            ...
                            <div className="flex gap-2 mb-6">
                                {BUSINESS.tags.map((tag) => (
                                    <span
                                        key={tag}
                                        className="text-sm bg-gold/20 text-mud px-3 py-1 rounded-full"
                                    >
                                        {tag}
                                    </span>
                                ))}
            ...
            <section className="section-padding bg-mud">
                <div className="container-custom">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-stone max-w-xl mx-auto">
                            Real reviews from real customers who brought Lippan art home.
                        </p>
                    </div>
            ...
            {/* CTA Banner */}
            <section className="section-padding bg-gradient-to-r from-sand to-sand-light">
                <div className="container-custom text-center">
                    ...
                    <p className="text-stone mb-8 max-w-xl mx-auto">
                        ...
                        colors — and let's bring it to life together.
                    </p>
